    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-50">
      <div className="bg-white rounded-lg shadow-lg p-8 max-w-2xl mx-4">
        <div className="text-center space-y-6">
          ...
          <button
            onClick={onContinue}
            className="bg-gray-600 text-white px-8 py-3 rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 font-semibold text-lg transition-colors"
          >
            本番へ進む
          </button>
        </div>
